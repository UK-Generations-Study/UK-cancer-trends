...
ggsave("../Output/Final_Plots/Figure_4_PIF.png", plot = plot, bg = "white", height = 8, width = 8)
...
### Supplemenrary Table 4 - AAPC/APC by cancer site
```{r, results = "asis"}
...
### Supplentary Figure 6? - Colorectal cancer and risk factor plotting
...
for(s in unique(rf_trend_plot_overlay$sex)){
  ...
  ggsave(filename = "../Output/Final_Plots/Supplementary_Figure_6.png", plot = plot, width = 8, height = 14, bg = "white")
