...
ggsave(paste0("../Output/Final_Plots/Figure_4.png"), plot = p, width = 12, height = 12)
ggsave(paste0("../Output/Final_Plots_SVG/Figure_4.svg"), plot = p, width = 12, height = 12)
...
### Supplementary Table 6 - RR scenarios for colorectal cancer and BMI (REMOVED?)
...
for(s in unique(data_joinpoint_AAPC$sex)){
  ...
  grid.text("^ - AAPC for 20-49 is significantly greater than 0 the AAPC for 50+ is not significantly greater than 0 or does not overlap with the confidence interval of the AAPC for 20-49", x = 0.3605, y = 0.008, gp = gpar(fontsize = 8))
  ...
  grid.text("^ - AAPC for 20-49 is significantly greater than 0 and the AAPC for 50+ is not significantly greater than 0 or does not overlap with the confidence interval of the AAPC for 20-49", x = 0.462, y = 0.01, gp = gpar(fontsize = 9, fontfamily = "Times New Roman", fontface = "plain"))
  dev.off()
  ...
  grid.text("^ - AAPC for 20-49 is significantly greater than 0 and the AAPC for 50+ is not significantly greater than 0 or does not overlap with the confidence interval of the AAPC for 20-49", x = 0.452, y = 0.01, gp = gpar(fontsize = 9, fontfamily = "Times New Roman", fontface = "plain"))
  dev.off()
...
### Supplementary Figure 5b - PIF - REMOVED?
...
# pif_plot
# 
# ggsave("../Output/Final_Plots/Supplementary_Figure_6b.png", plot = pif_plot, bg = "white", height = 6, width = 10)
