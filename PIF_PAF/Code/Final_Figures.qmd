...
ggsave("../Output/Final_Plots/Figure_3.png", plot = data_attr_bar_paf, bg = "white", height = 4, width = 9)
ggsave("../Output/Final_Plots_SVG/Figure_3.svg", plot = data_attr_bar_paf, bg = "white", height = 4, width = 9)
...
ggsave(paste0("../Output/Final_Plots/Figure_4_20_49.png"), plot = p, width = 12, height = 12)
...
# Save the plot as a PNG file
ggsave(paste0("../Output/Final_Plots/Figure_4_50_plus.png"), plot = p, width = 12, height = 12)
ggsave(paste0("../Output/Final_Plots_SVG/Figure_4_50_plus.svg"), plot = p, width = 12, height = 12)
...
for(sex in names(supp_table_4)){
  ...
  # Save
  gtsave(supp_table_4[[sex]], paste0("../Output/Final_Plots/Supplementary_Table_4", letters[which(names(supp_table_4) == sex)], ".html"))
...
for(sex in names(supp_table_5)){
  ...
  # Save
  gtsave(supp_table_5[[sex]], paste0("../Output/Final_Plots/Supplementary_Table_5", letters[which(names(supp_table_5) == sex)], ".html"))
...
for(group in names(bmi_jp_table)){
  ...
  gtsave(bmi_jp_table[[group]], paste0("../Output/Final_Plots/Supplementary_Table_6", letters[which(names(bmi_jp_table) == group)], ".html"))
...
for(var in unique(paste0(rf_imd_trend_plot$variable, "-", rf_imd_trend_plot$level))){
  ...
  svglite(paste0("../Output/Final_Plots_SVG/Supplementary_Figure_3", letters[which(unique(paste0(rf_imd_trend_plot$variable, "-", rf_imd_trend_plot$level)) == var)], "_unannotated.svg"), width = 6, height = 4, bg = "white")
  grid.draw(g)
  dev.off()
  
  ggsave(filename = paste0("../Output/Final_Plots/Supplementary_Figure_3", letters[which(unique(paste0(rf_imd_trend_plot$variable, "-", rf_imd_trend_plot$level)) == var)], ".png"), plot = plot, width = 6, height = 4, bg = "white")
  ggsave(filename = paste0("../Output/Final_Plots_SVG/Supplementary_Figure_3", letters[which(unique(paste0(rf_imd_trend_plot$variable, "-", rf_imd_trend_plot$level)) == var)], ".svg"), plot = plot, width = 6, height = 4, bg = "white")
...
for (var in unique (data_attr_cases_bar$variable)) {
  ...
  ggsave(filename = paste0("../Output/Final_Plots/Supplementary_Figure_4", letters[which(unique (data_attr_cases_bar$variable) == var)], ".png"), plot = data_attr_bar_paf, width = 6, height = 4, bg = "white")
  ggsave(filename = paste0("../Output/Final_Plots_SVG/Supplementary_Figure_4", letters[which(unique (data_attr_cases_bar$variable) == var)], ".svg"), plot = data_attr_bar_paf, width = 6, height = 4, bg = "white")
  ...
  if(var == "Body Mass Intake (BMI)"){
    ...
    ggsave(filename = paste0("../Output/Final_Plots/Supplementary_Figure_4", letters[which(unique (data_attr_cases_bar$variable) == var)], "_alt.png"), plot = data_attr_bar_paf, height = 4, width = 9, bg = "white")
    ggsave(filename = paste0("../Output/Final_Plots_SVG/Supplementary_Figure_4", letters[which(unique (data_attr_cases_bar$variable) == var)], "_alt.svg"), plot = data_attr_bar_paf, height = 4, width = 9, bg = "white")
  }
...
for(s in unique(rf_trend_plot_overlay$sex)){
  ...
  ggsave(filename = paste0("../Output/Final_Plots/Supplementary_Figure_7", letters[which(unique(rf_trend_plot_overlay$sex) == s)], ".png"), plot = plot, width = 8, height = 14, bg = "white")
  ggsave(filename = paste0("../Output/Final_Plots_SVG/Supplementary_Figure_7", letters[which(unique(rf_trend_plot_overlay$sex) == s)], ".svg"), plot = plot, width = 8, height = 14, bg = "white")
