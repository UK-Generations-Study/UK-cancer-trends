...
source("Functions/Data_Generation/hse_data_cleaning_functions.R")
source("Functions/Data_Generation/alcohol_data_generation.R")
source("Functions/Data_Generation/bmi_data_generation.R")
source("Functions/Data_Generation/physical_activity_old_data_generation.R")
source("Functions/Data_Generation/physical_activity_data_generation.R")
source("Functions/Data_Generation/diet_data_generation.R")
source("Functions/Data_Generation/diet_data_generation_continuous.R")
source("Functions/Data_Generation/diet_data_generation_cat_mean.R")
source("Functions/Data_Generation/smoking_data_generation.R")
...
ghs_data <- ghs_data |>
  ...
  mutate(
    ...
    alcohol_cat = case_when(
      ...
      drating < 10.5 ~ "Light Drinker",
      drating < 43.75 ~ "Moderate Drinker",
      TRUE ~ "Heavy Drinker")
