...
data_20_34 <- read.csv(r"(..\..\Data\Incidence_data_for_England_2025-01-31.csv)")
data_35_49 <- read.csv(r"(..\..\Data\Incidence_data_for_England_2025-01-31 (1).csv)")
data_50_64 <- read.csv(r"(..\..\Data\Incidence_data_for_England_2025-01-31 (2).csv)")
data_oe65 <- read.csv(r"(..\..\Data\Incidence_data_for_England_2025-01-31 (3).csv)")

# Format data
data <- rbind(data_20_34 |>
                mutate(age_group = "20-34"),
              data_35_49 |>
                mutate(age_group = "35-49")) |>
  rbind(data_50_64 |>
...
data <- data |>
  mutate(
    ...
    Rate = if_else(Rate == "[u]", 0, as.numeric(Rate))
...
# Output
write.csv(data, r"(..\..\Data\all_incidence_age_group_joinpoint.csv)", row.names = F)
