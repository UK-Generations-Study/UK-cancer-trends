...
1.  Smoking/Alcohol/BMI by IMD
2.  Risk factor plots by age (\<30, 30-50, 50-70, 70+)
3.  WHY is the all ages PAF so different than the PAF split by age
4.  BMI data is only until 2018 (even in the figure reports)- where is 2019?
5.  Ultra Processed Foods and Colorectal RR scenario generation - not sure if valid due to different definition of prevalence
6.  PHYSICAL ACTIVITY!!
...
## Figure 2 - Trends in risk factors APC table
