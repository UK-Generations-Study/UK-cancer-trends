...
for (group in age_groups) {
  ...
  plot <- ggplot(data_subset, aes(x = year, y = rate, fill = sex, colour = sex)) +
    ...
    labs(subtitle = "Labels show AAPC for most recent trend, * indicates a significant trend") +
...
data_cancer <- data_ALLcancer %>%
  filter(
    cancer_site %in% c("Oral", "Endometrium", "Pancreas", "Gallbladder", "Colorectum", "Liver", "Kidney", "Multiple Myeloma", "Breast")
  )
