...
## Ongoing broad analysis questions (for discussion) 
...
1. Data is available at different levels for each risk factor. Smoking has consistent data from 1995-2019 whereas physical activity only has 4 data points with the same physical activity definitions 
...
Colon vs. Colorectal Cancer and physical activity 

PIF for alcohol - it is increasing? 
