...
# plot_joinpoint_output("Prostate", sex = 3, data, data_jp, incmort, start.yr = NA, projection.yr = 2040, projection.target = 0.85, report.APC = FALSE, moonshot.target = FALSE)
```
