...
screening_data_breast <- read_excel("Screening_Data.xlsx", sheet = "England_Breast_Uptake")
...
screening_data_bowel <- read_excel("Screening_Data.xlsx", sheet = "England_Bowel_Coverage")
...
screening_data_bowel <- read_excel("Screening_Data.xlsx", sheet = "England_Bowel_Uptake")
...
screening_data_bowel |>
  ...
  xlab("Year") +
  ylab("% Coverage") +
  ggtitle("% Bowel Screening Uptake in England") +
  scale_x_continuous(breaks = pretty_breaks())
