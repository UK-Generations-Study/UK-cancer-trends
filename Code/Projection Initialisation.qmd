...
data <- data_england_wales |>
  ...
  select(Year, Sex, `ASR (World)`, `Cancer label`, `Country label`, incmort) |>
  
  arrange(Sex, `Cancer label`, incmort, `Country label`, Year, `ASR (World)`)
  
write.csv(data, "Cancer_Joinpoint_Data_by_Country.txt", row.names = F)
