...
#run Fibre Code
source("Code/PAF/FibreCode.R")
#run Red Meat 
source("Code/PAF/RedMeatCode.R")
#run Processed Meat 
source("Code/PAF/ProcessedMeatCode.R")
...
Mcolorectalcancer <- grid.arrange(smoking_colorectalmen, bmi_colorectalmen, alcohol_colorectalmen, fibre_colorectalmen, redmeat_colorectalmen,processedmeat_colorectalmen, ncol = 2, top = "MEN")
