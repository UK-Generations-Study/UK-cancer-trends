...
One of the biggest discrepancies in current PAF literature is the RR for fibre. The RR used in this analysis is 0.91(0.87, 1.00) per 10g increment of fibre per day and is sourced from a meta-analysis from the \[WCRF\](Wholegrains, vegetables and fruit and the risk of cancer (wcrf.org).The RR can be transformed to be an ERR per 1g/day by: $$
per 1 g = ln(\frac1{0.93}) = \frac {0.073}{10g} * 10 = \frac {0.007}{1g} deficit from 30g/day
