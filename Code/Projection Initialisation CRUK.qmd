...
```{r}
setwd("C:/Users/rfrost/OneDrive - The Institute of Cancer Research/Documents/UK-cancer-trends/Data/Cancer Trends/CRUK")
...
write.csv(inc_data, "Cancer_Incidence_Data_CRUK.txt", row.names = F)
...
```{r}
setwd("C:/Users/rfrost/OneDrive - The Institute of Cancer Research/Documents/UK-cancer-trends/Data/Cancer Trends/CRUK Extra")

cancers <- c("Liver Cancer (C22)", "Bladder Cancer (C67)", "Brain")

inc_data <- read_excel("C:/Users/rfrost/OneDrive - The Institute of Cancer Research/Documents/UK-cancer-trends/Data/Cancer Trends/CRUK/Cancer_Projection_Data_CRUK.xlsx", sheet = "Incidence")
...
mort_data <- read_excel("C:/Users/rfrost/OneDrive - The Institute of Cancer Research/Documents/UK-cancer-trends/Data/Cancer Trends/CRUK/Cancer_Projection_Data_CRUK.xlsx", sheet = "Mortality")
