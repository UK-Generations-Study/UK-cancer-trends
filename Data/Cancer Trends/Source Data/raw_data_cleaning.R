...
# This code is designed to clean the raw cancer incidence data drawn from national sources into one .csv that can be used for input into joinpoint and plotting.
...
## ENGLAND DATA
cancer_england <- read_excel(r"(C:\Users\rfrost\OneDrive - The Institute of Cancer Research\Documents\UK-cancer-trends\Data\Cancer Trends\Source Data\Raw Data\Cancer_England.xlsx)") |>
...
cancer_wales_sheets <- excel_sheets(r"(C:\Users\rfrost\OneDrive - The Institute of Cancer Research\Documents\UK-cancer-trends\Data\Cancer Trends\Source Data\Raw Data\Cancer_Wales.xlsx)")
...
cancer_nireland_sheets <- excel_sheets(r"(C:\Users\rfrost\OneDrive - The Institute of Cancer Research\Documents\UK-cancer-trends\Data\Cancer Trends\Source Data\Raw Data\Cancer_NIreland.xlsx)")

# Loop through sheets, adding data to dataframe
for(sheet in cancer_nireland_sheets){
  
  temp_data <- read_excel(r"(C:\Users\rfrost\OneDrive - The Institute of Cancer Research\Documents\UK-cancer-trends\Data\Cancer Trends\Source Data\Raw Data\Cancer_NIreland.xlsx)", sheet = sheet)
